        ...
        <>
            <div className="flex flex-col lg:flex-row gap-8 items-start px-6 mb-5 ">
                <div className="lg:w-3/5 mt-15">
                    <h1 className="text-lg text-red-700 font-bold">In Nederland moet er meer aandacht naar de mentale gezondheid van de burger in Nederland.</h1><br></br>
                    <p className="text-sm">
                        ...
                        Iedereen ervaart weleens stress, somberheid of spanning, maar als deze klachten te lang aanhouden of het functioneren beïnvloeden, kan er sprake zijn van een psychisch probleem zoals angst, depressie of burn-out.<br></br><br></br>
                        ...
                        Ook in het onderwijs wordt mentale gezondheid versterkt, onder meer door weerbaarheidstrainingen en het ondersteunen van docenten bij het signaleren van problemen.<br></br><br></br>
                        ...
                        Voor volwassenen en werkenden stimuleert de overheid dat werkgevers aandacht besteden aan mentale gezondheid op de werkvloer, bijvoorbeeld door goede begeleiding bij werkdruk of stress.<br></br><br></br>
                        ...
                        De focus ligt steeds meer op preventie en vroegtijdige ondersteuning, zodat mensen niet pas hulp krijgen als de problemen ernstig zijn, maar al in een vroeg stadium geholpen worden.<br></br><br></br>
